...
export const environment = {
    ...
    /*
    supabaseUrl: 'https://tstpedxohgaopfyialvw.supabase.co',
    supabaseKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJxdnFrbWRyaGR5dWpxaWF5ZW91Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc2NTAxMTYsImV4cCI6MjA2MzIyNjExNn0.M5fLTr_g_qp2-KzXvzzJwOGAjavnlNz-R3tD7ssYG-0'
     */
